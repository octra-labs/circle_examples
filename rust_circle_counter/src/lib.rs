...
fn run_query(ptr: i32, len: i32) -> i32 {
    ...
    match request.method.as_str() {
        ...
        "fhe_verify_range_of" => {
            ...
            match Host::fhe_verify_range(pubkey_b64, ciphertext, proof) {
                Ok(value) => Host::respond_value(Value::Bool(value)),
                Err(code) => code,
            }
        }
